        ...
        <div class="row">
            <div class="col-sm-12 page-content-list">
                <div class="panel panel-default">
                    <div class="panel-heading">Gallery | List
                        <div class="pull-right">
                            <a class="btn btn-primary form-ajax-action" data-href="{{ action('Backend\GalleryController@create') }}">New</a>
                        </div>
                    </div>
                    <!-- /.panel-heading -->
...
<script>
    jQuery(document).ready(function(){
        $('#datatable_ajax').DataTable({
            ...
            "searching": true,
            "ajax": {
                "url": "{{ action('Backend\GalleryController@table') }}",
                "type": "POST",
